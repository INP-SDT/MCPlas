...
%------------------------------------------------------------------------------- 
  ...
  ActivatePlasma('FluidPoisson', true);
...
%  model.sol('sol1').feature('t1').feature('fc1').set('dtech', 'auto');
  ...
  msg(2,'Solver: fully coupled with const Newton iteration');

  model.sol('sol1').feature('t1').set('timemethod', 'genalpha');
  model.sol('sol1').feature('t1').set('initialstepgenalphaactive', 'on');
  model.sol('sol1').feature('t1').set('initialstepgenalpha', '1e-13');
...
% set probes
  SetProbe('global','Circuit','prob_Idischarge','Idischarge')
%  SetProbe('global','Circuit','prob_U0','PoweredVoltage')
  SetProbe('point','Circuit','probU0',{'Phi'},'0[mm]')
  SetProbe('point','Circuit','probU1',{'Phi'},'ElecDist')
  SetProbe('global','Circuit','prob_Udischarge','probU0_Phi-probU1_Phi')
  
% create surface and cut plots
  inp.DataSet='dset1';
  Axial.name='AxialCut';
    Axial.r1='0'; Axial.z1='0';
    Axial.r2='0'; Axial.z2='ElecDist';
  PrepPostPlasma(Axial);
