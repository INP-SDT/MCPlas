function SetGeometry(inp, flags, model)
    ...
    GeomTitle = '1D plane-parallel';  % Title/label for the geometry
    ...
    model.frame('material1').coord(1, 'z');  % Set coordinate 1 to 'z' (1D axis)
    model.frame('material1').coord(3, 'x');  % Set coordinate 3 to 'x' 
