...
%-------------------------------------------------------------------------------
    if length(strfind(GeomName,'Geom1D'))>0
        ...
        % boundary fluxes for all species
        variablesname = 'bndfluxes';
        ...
        for i = 1:inp.Nspec
            ...
            if i == inp.eInd
                ...
                % secondary electron emission for positive ions, only
                posinp.iInd = find(inp.Z(inp.iInd)>0);
                ...
                for j = 1:length(posinp.iInd)
                    ...
                    iflux = [iflux,'max(F', ...
                        num2str(inp.iInd(posinp.iInd(j))),'_z*eq',id,'.nz,0)'];
                end
...
%-------------------------------------------------------------------------------
% spatially one-dimensional (axisymmetric)
%-------------------------------------------------------------------------------
        ...
        for i = 1:inp.Nspec
            ...
            if i == inp.eInd
                ...
                for j = 1:length(posinp.iInd)
                    ...
                    iflux = [iflux,'max(F', ...
                        num2str(inp.iInd(posinp.iInd(j))),'_r*eq',id,'.nr,0)'];
                end
...
%-------------------------------------------------------------------------------        
    elseif length(strfind(GeomName,'Geom2D'))>0
        ...
        % set drift + convection velocity
        variablesname = 'specprop';
        
        % for all species    
        if strcmp(flags.convflux,'on')
          msg(3,'convection included')
          vconv_x='+u';
          vconv_y='+w';
        else
          msg(3,'convection not included')
          vconv_x='';
          vconv_y='';
        end
        ...
        for i = 1:inp.Nspec
            ...
            if i == inp.eInd
                ...
                for j = 1:length(posinp.iInd)
                    ...
                    iflux = [iflux, ...
                        'max(F',num2str(inp.iInd(posinp.iInd(j))),'_y*eq',id,'.ny + F', ...
                        num2str(inp.iInd(posinp.iInd(j))),'_x*eq',id,'.nx,0)'];
                end
...
%-------------------------------------------------------------------------------        
% Spatially two-dimensional (axisymmetric)
%-------------------------------------------------------------------------------        
        ...
        for i = 1:inp.Nspec
            ...
            if i == inp.eInd
                ...
                for j = 1:length(posinp.iInd)
                    ...
                    iflux = [iflux, ...
                        'max(F',num2str(inp.iInd(posinp.iInd(j))),'_z*eq',id,'.nz + F', ...
                        num2str(inp.iInd(posinp.iInd(j))),'_r*eq',id,'.nr,0)'];
                end
